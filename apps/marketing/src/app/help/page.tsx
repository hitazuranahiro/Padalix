...
export default async function HelpPage() {
  ...
  return <><SiteHeader appUrl={appUrl} /><main className="support-page">
    <section className="support-hero" aria-labelledby="help-title"><Image src={mediaUrl("images/padalix-social-logo.png")} alt="" fill priority sizes="50vw" /><div className="support-hero-copy"><p className="eyebrow mono">{help.eyebrow}</p><h1 id="help-title">{help.title}</h1><p>{help.introduction}</p><Link className="cut-button cut-button-light" href="#help-topics">Browse help topics <ArrowRight size={16} /></Link></div><div className="support-hero-index mono">HELP / 01</div></section>
