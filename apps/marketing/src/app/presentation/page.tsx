...
export const metadata: Metadata = { title: "Padalix Presentation", description: "Padalix product flow, features, market, and Stellar integration case." };
...
export default async function PresentationPage() {
  ...
  return <><SiteHeader appUrl={appUrl} /><main className="interior-page presentation-page">
    ...
    <section className="document-section"><header><div><p className="section-number mono">06 / SOURCE DOCUMENT</p><h2>{presentation.documentLabel}</h2></div><a className="document-link" href={presentation.documentUrl} target="_blank" rel="noreferrer"><FileText size={18} /><span>Open submission PDF</span><ArrowUpRight size={16} /></a></header><iframe src={presentation.documentUrl} title={presentation.documentLabel} /></section>
